...
;
;static PFX_DEVICE_DRIVER exportDriver(VOID);
;static LPVOID			 exportDriverData(VOID);
;
...
DRVDATA	section
	ends
;
;typedef struct driver_static
;{
;	int i;
;	int y;
;}DRIVER_DATA_13;
	.stag	driver_static,32,90
	.member	i,0,5,8,16
	.member	y,16,5,8,16
	.eos
;
;static DRIVER_DATA_13 FAR data = {0};
	DRVDATA
~~data:
	dw	$0
	ds	2
...
~~exportDriver:
	...
	tcd
	.block	73
;	return (LPVOID)((ULONG)&DRIVER_DESC);
	.line	74
	lda	#^~~DRIVER_DESC
	tax
	lda	#<~~DRIVER_DESC
...
;
	.line	80
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\ddk\DRIVER_S13.c",77
	.sym	~~DRIVER_DESC,~~DRIVER_DESC,10,3,776,58
	.sym	~~data,~~data,10,3,32,90
	.sym	DRIVER_DATA_13,0,10,14,32,90
	...
	.sym	~~exportDriverData,~~exportDriverData,1089,3,32
	.sym	~~exportDriver,~~exportDriver,1098,3,32,58
